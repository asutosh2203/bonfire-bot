...
export default function InviteNotFound() {
  return (
    <div className="bg-[url('/not-found.webp')] bg-cover bg-center min-h-screen flex items-center justify-center p-4">
      ...
      <div className='relative z-10 bg-[#2B2D31] p-8 rounded-lg shadow-2xl max-w-md w-full text-center border border-red-500/20 animate-in fade-in zoom-in-95 duration-300'>
        ...
        <p className='text-gray-400 mb-6'>
          This invite link is DOA, JUST like your love life. The owner might
          have revoked it, or it never existed.
        </p>
